...
const Stars = ({stars, reviews}) => {
  ...
  //2 different methods of adding the stars

  //2nd argument in array.from() is the callback function. The first parameter for this 2nd argument is the actual item which we do not care about so we pass in the underscore
